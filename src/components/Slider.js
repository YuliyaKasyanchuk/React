...
class Slider extends React.Component{
	constructor(props){
		...
		this.intevalBetweenSlides = this.intevalBetweenSlides.bind(this);
	...
	componentDidMount(){
		this.interval = setInterval(()=> this.intevalBetweenSlides(), 3000)
	}
	componentWillUnmount(){
		clearInterval(this.interval)
	}
	intevalBetweenSlides(){
	...
	renderPlayStop() {
		...
		if(this.state.autoplay){
			...
			<svg fill="#FFFFFF" height='24' viewBox='0 0 24 24' width='24'>
				<path d='M0 0h24v24H0z' fill='none' />
				<path d='M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 14.5v-9l16 4.5-6 4.5z'  />
				...
				<div>
					 <button 
					 	...
					 	<svg fill="#FFFFFF" height='50' viewBox='0 0 24 24' width='50'>
					 		<path d='M15.41 7.14L14  6l-6 6 6 6 1.41-1.41L10.83 12z' />
							<path d='M0 0h24v24H0z' fill='none' />
					 	</svg>
					 	</button>
